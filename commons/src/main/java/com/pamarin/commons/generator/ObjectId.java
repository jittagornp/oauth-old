...
public final class ObjectId implements Comparable<ObjectId>, Serializable {
     ...
     * @throws IllegalArgumentException if the buffer is null or does not have
     * at least 12 bytes remaining
     * @since 3.4
     */
    ...
    private static <T> T isTrueArgument(final String name, final T value, final boolean condition) {
        if (!condition) {
