 ...
 *
 *
 * https://github.com/zgsolucoes/spring-session-base/blob/master/src/main/java/org/grails/plugins/springsession/data/redis/RedisSecurityContextRepository.java
 */
public class RedisSecurityContextRepository implements SecurityContextRepository {

    public static final String SPRING_SECURITY_CONTEXT_KEY = "SPRING_SECURITY_CONTEXT";
    public static final String SECURITY_CONTEXT_ID = "user-session";
    ...
    final class SaveToSessionResponseWrapper extends SaveContextOnUpdateOrErrorResponseWrapper {
         ...
         * are wrapping.
         *
         * @param request the request object (used to obtain the session, if one
         * exists).
         * @param httpSessionExistedAtStartOfRequest indicates whether there was
         * a session in place before the filter chain executed. If this is true,
         * and the session is found to be null, this indicates that it was
         * invalidated during the request and a new session will now be created.
         * @param contextHashBeforeChainExecution the hashcode of the context
         * before the filter chain executed. The context will only be stored if
         * it has a different hashcode, indicating that the context changed
         * during the request.
         */
         ...
         *
         * @param context the context object obtained from the
         * SecurityContextHolder after the request has been processed by the
         * filter chain. SecurityContextHolder.getContext() cannot be used to
         * obtain the context as it has already been cleared by the time this
         * method is called.
         *
         */
        @Override
